...
class VulkanRenderHardwareProvider : public IRenderHardwareProvider {
public:
    VulkanRenderHardwareProvider(IVulkanInstanceFactory* vulkanInstanceFactory, IVulkanDeviceFactory* vulkanDeviceFactory,
