...
#include "Memory/VulkanAllocationConfiguration.h"

class IVulkanDevice {
public:
    [[nodiscard]] virtual bool Initialize(const vk::raii::PhysicalDevice& physicalDevice, vk::QueueFlags requestedQueues,
        const std::vector<VulkanExtension> &requestedExtensions, const VulkanAllocationConfiguration& memoryAllocationConfiguration) = 0;
